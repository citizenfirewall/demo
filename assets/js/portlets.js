...
(function($) {
    ...
    $(".sortable .row .col-md-4").sortable({
        connectWith: ".sortable .row .col-md-4",
        handle: ".panel-heading",
        cancel: ".portlet-close",
        placeholder: "sortable-box-placeholder round-all",
        ...
        $(".sortable .row .col-md-3").sortable({
        connectWith: ".sortable .row .col-md-3",
        handle: ".panel-heading",
        cancel: ".portlet-close",
        placeholder: "sortable-box-placeholder round-all",
    ...
    //     $(".sortable .timeline-block .timeline-point .timeline-content .card").sortable({
    //     connectWith: ".sortable .timeline-block .timeline-point .timeline-content .card",
    //     handle: ".panel-heading",
    //     cancel: ".portlet-close",
    //     placeholder: "sortable-box-placeholder round-all",
